// --- Core WebGL Utilities moved to Module Scope --- //
...
function eProperty(object, propertyName, val) {
      ...
      PlaneGeometry: {
        ...
        value: class {
          ...
          setSize(width = 1, height = 1, orientation = "xz") {
            ...
            if (!geometry.attributes.position.values || geometry.attributes.position.values.length !== 3 * geometry.vertexCount) geometry.attributes.position.values = new Float32Array(3 * geometry.vertexCount);
            const o = width / -2,
              r = height / -2,
...
class Gradient {
  constructor() {
    eProperty(this, "cssVarRetries", 0);
    eProperty(this, "maxCssVarRetries", 200);
    eProperty(this, "angle", 0);
    eProperty(this, "isLoadedClass", !1);
    eProperty(this, "isScrolling", !1);
    eProperty(this, "isIntersecting", !1);
    eProperty(this, "t", 1253106);
    eProperty(this, "last", 0);
    eProperty(this, "minWidth", 1111);
    eProperty(this, "height", 600);
    eProperty(this, "amp", 320);
    eProperty(this, "seed", 5);
    eProperty(this, "freqX", 14e-5);
    eProperty(this, "freqY", 29e-5);
    eProperty(this, "activeColors", [1, 1, 1, 1]);
    eProperty(this, "isMouseDown", !1);

    eProperty(this, "resize", () => {
    ...
    eProperty(this, "addIsLoadedClass", () => {
    ...
    eProperty(this, "initGradient", (el) => {
  ...
  async connect() {
    ...
    this.conf = { presetName: "", wireframe: false, density: [0.06, 0.16], zoom: 1, rotation: 0, playing: true };
...
export default class StripeAnimationController {
  constructor(selector = ".gradient-canvas") {
    this.selector = selector;
    this.init();
  }

  init() {
    const canvases = document.querySelectorAll(this.selector);
    canvases.forEach((canvasEl) => {
      const gradient = new Gradient();
      gradient.initGradient(canvasEl);
    });
  }
}
