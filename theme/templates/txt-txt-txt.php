<section class="container grid grid-cols-12 gap-x-grid gap-y-12 my-20 lg:my-40">
	...
	$columns = [
		...
		[
			'txt'  => get_sub_field('txt_center'),
			'link' => get_sub_field('link_center'),
		],
		[
	...
	<div class="col-span-12 lg:mx-auto grid gap-x-grid gap-y-12 lg:grid-cols-3 lg:col-span-10 lg:col-start-2">
